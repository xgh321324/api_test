...
if __name__ == '__main__':
    ...
    #run所有用例
    #be_run.run(all_case())
    report_path = r'C:\Users\Administrator\Documents\GitHub\Medohealth\report\2018-4-23-first.html'  #报告存放路径,若用HTMLTestRunner则要加上具体文件名称
    ...
    Send_email('15651797525@163.com',
               ...
               ,r'C:\Users\Administrator\Documents\GitHub\Medohealth\report\2018-4-23-first.html').send()  #xgh321324是授权码登录
