...
if __name__ == '__main__':
    ...
    #run所有用例
    #be_run.run(all_case())
    report_path = r'C:\Users\Administrator\Documents\GitHub\Medohealth\report\2018-4-20-end.html'  #报告存放路径,若用HTMLTestRunner则要加上具体文件名称

    with open(report_path,'wb') as f:
        runner = HTMLTestRunner.HTMLTestRunner(stream=f,
                                               title='麦豆接口测试',
                                               description='这是4月20日的测试结果',
                                               verbosity=2)
    ...
    Send_email('15651797525@163.com',
               ...
               ,r'C:\Users\Administrator\Documents\GitHub\Medohealth\report\2018-4-20-end.html').send()  #xgh321324是授权码登录
