...
class Test_pay(unittest.TestCase):
    ...
    def testpayment(self):
        ...
        json_data2 = {"payType":"1","user_source":"1","product_type":"2","token":t,"product_code":"KC2018032711206"}  #上一接口返回的token现在用来做请求参数
    ...
    def testpayment2(self):
        ...
        json_data2 = {"payType":"0","user_source":"1","product_type":"2","token":t,"product_code":"KC2018032711206"}
        url2 ='http://api.exam.sunnycare.cc/v1/mldProductPay'#支付接口地址
        r2 = self.s.post(url2,headers=self.header,json=json_data2)
        print(r2.json())
        self.assertEqual(200,r2.json()['code'])
    def testpayment3(self):
        ...
        #上一接口返回的token现在用来做请求参数
        json_data2 = {"payType":"0","user_source":"1","product_type":"3","token":t,"product_code":"ZL2018032753586"}
        url2 ='http://api.exam.sunnycare.cc/v1/mldProductPay'#支付接口地址
        r2 = self.s.post(url2,headers=self.header,json=json_data2)
        print(r2.json())
        self.assertEqual(200,r2.json()['code'])
